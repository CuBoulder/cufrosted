 ...
 */
function cufrosted_preprocess_html(&$vars) {

  // SET BANNER COLOR (banner-white, banner-light, banner-dark, banner-black)
  $banner_color = theme_get_setting('banner_color', 'cufrosted') ? theme_get_setting('banner_color', 'cufrosted') : 'black';
  //$banner_color = 'black';
  ...
  $layout = theme_get_setting('layout_style', 'cufrosted') ? theme_get_setting('layout_style', 'cufrosted') : 'layout-wide';
